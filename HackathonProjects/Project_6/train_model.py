...
class CryptoDataset(data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        return np.squeeze(feats), target
...
if __name__ == '__main__':
    ...
    assert not (args.no_hist and args.no_r), "Only choose one, dummy"
    ...
    # Best Acc: 4 feats (no reddit): 0.714
    # P_target = 0.356
    ...
    # Best Acc: 6 feats (no hist): 0.657
    # Best Acc: 4 feats (no reddit): 0.629
    # P_target = 0.487
